                ...
                <div class="col-2">
                    <div class="form-container">
                        <div class="form-btn">
                            ...
                            if (isset($_POST['register']) && $_POST['username'] != '' && $_POST['password'] != '' && $_POST['hoten'] != '') {
                                $sql = "INSERT INTO khachhang (username,hoten,password,type) VALUES ('$username','$hoten','$password', '$type')";
